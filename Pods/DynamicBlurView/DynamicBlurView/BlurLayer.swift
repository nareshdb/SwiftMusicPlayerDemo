...
class BlurLayer: CALayer {
     ...
     static let blurLayoutKey = "blurLayout"
    @NSManaged var blurRadius: CGFloat
    @NSManaged  var blurLayout: CGFloat

     var fromBlurRadius: CGFloat?
...
extension BlurLayer {
    ...
    func render(in context: CGContext, for layer: CALayer) {
     ...
     func hideOverlappingLayers(_ layers: [CALayer]?) -> [CALayer] {
     ...
     func isHang(to target: CALayer) -> Bool {
